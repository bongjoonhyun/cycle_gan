...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--gpu_ids', type=str, default='1,2,3,4,5,6,7,8',
                            help='gpu '
                                 'ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--checkpoints_dir', type=str,
                            default='./checkpoints',
                            help='models are saved here')
        # model parameters
        parser.add_argument('--model', type=str, default='cycle_gan',
                            help='default for cycle_gan')
        ...
        parser.add_argument('--netD', type=str, default='basic',
                            help='specify discriminator architecture [attention_basic | basic | advanced(PA4)]. ')
        parser.add_argument('--netG', type=str, default='basic',
                            help='specify generator architecture [attention_basic | basic | advanced(PA4)]')
    ...
    def parse(self):
        ...
        # process opt.suffix
        if opt.suffix:
            suffix = ('_' + opt.suffix.format(
                **vars(opt))) if opt.suffix != '' else ''
